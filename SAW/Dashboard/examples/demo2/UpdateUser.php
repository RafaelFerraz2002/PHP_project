...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err)){
        ...
        $sql = "UPDATE user SET nome=?, email=?, idade=?, roles=?, pass=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssssi", $param_name, $param_address, $param_salary, $param_roles, $param_pass, $param_id);
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>"
                                    ...
                                    <a href="ReadUser.php" class="btn btn-secondary ml-2">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
